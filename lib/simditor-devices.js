(function() {
  ...
  (function(factory) {
    ...
    DevicesButton = (function(_super) {
      ...
      DevicesButton.prototype.openViewer = function(content) {
        var className, html, title;
        title = '手机预览';
        className = 'mobile';
      ...
      DevicesButton.prototype.doMobileView = function() {
        return this.openViewer(this.editor.getValue());
      };
